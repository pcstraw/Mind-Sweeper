...
nativenamespace{
	...
	class ShaderForLines : public Shader
	{
	public:
		ShaderForLines()
		{
		...
		void DrawAxis(glm::vec3 point, float scale,glm::mat4 transform, glm::mat4 projection)
		{
		...
		void DrawLine(const glm::vec3& point1, const glm::vec3& point2, const glm::vec4& col1, const glm::mat4& projectionMatrix)
		{
			DrawLine(point1, point2, col1, col1, 1.f, projectionMatrix, true);
		}

		void DrawLine(const glm::vec3& point1, const glm::vec3& point2, const glm::vec4& col1, const glm::vec4& col2, const glm::mat4& projectionMatrix)
		{
