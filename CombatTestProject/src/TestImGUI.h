...
nativenamespace{
	...
	class TestImGUIScene : public SceneBase
	{
	public:
		...
		void OnUpdate() override
		{
			...
			/*
			bool opened = false;
			vec2 sp = camera.WorldToScreen(origin);
			...
			*/
			...
			lineShader.DrawAxis(origin,5.f,mat4(1.f), camera.projectionViewMatrix);
		...
		void TestGUI()
		{
			...
			// 2. Show a simple window that we create ourselves. We use a Begin/End pair to created a named window.
			{
				...
				ImGui::SliderFloat("float", &f, 0.0f, 1000.0f);            // Edit 1 float using a slider from 0.0f to 1.0f
...
int main2(int, char**)
{
	...
	if (font1 == nullptr)bool breakHere = true;
